# ДЗ
# задача2: Найдите сумму цифр трехзначного числа. *Пример:* 123 -> 6 (1 + 2 + 3), 100 -> 1 (1 + 0 + 0)

# a = int(input('Введите трехзначное число'))
# print(a//100 + a//10%10 + a%10)

# задача4: Петя, Катя и Сережа делают из бумаги журавликов. Вместе они сделали S журавликов. Сколько журавликов сделал каждый ребенок, если известно, 
...
# n, m, k = int(input('Введите одну сторону шоколадки: ')), int(input('Введите вторую сторону шоколадки: ')), int(input('Введите долек для отлома: '))
